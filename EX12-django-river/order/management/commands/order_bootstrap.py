...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # 创建状态
        draft_state, _ = State.objects.update_or_create(label="Draft", slug="draft")
        issued_state, _ = State.objects.update_or_create(label="Issued", slug="issued")
        partreceived_state, _ = State.objects.update_or_create(label="Part Received", slug="partreceived")
        received_state, _ = State.objects.update_or_create(label="Received", slug="received")
        ...
        # 部分收货 -> 收货完成
        partreceived_to_received_meta, _ = TransitionApprovalMeta.objects.update_or_create(
        ...
        Product.objects.update_or_create(name='测试产品')
