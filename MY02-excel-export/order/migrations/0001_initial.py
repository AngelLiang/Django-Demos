# Generated by Django 2.2.14 on 2020-07-17 06:50
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.CharField(blank=True, default='', max_length=40, verbose_name='订单号')),
                ('order_date', models.DateField(verbose_name='订单日期')),
                ('title', models.CharField(default='', max_length=255, verbose_name='标题')),
                ('description', models.TextField(default='', max_length=10000, verbose_name='描述说明')),
                ('amount', models.DecimalField(blank=True, decimal_places=2, max_digits=11, null=True, verbose_name='总金额')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, max_digits=11, verbose_name='单价')),
                ('amount', models.DecimalField(blank=True, decimal_places=2, max_digits=11, null=True, verbose_name='总价')),
