...
class Product(models.Model):
    ...
    price = MoneyField(verbose_name='单价', max_digits=14, decimal_places=2, default_currency='CNY')
...
class Order(models.Model):
    ...
    amount = MoneyField(verbose_name='总金额', max_digits=14, decimal_places=2,blank=True, default=Money(0, 'CNY'), default_currency='CNY')
