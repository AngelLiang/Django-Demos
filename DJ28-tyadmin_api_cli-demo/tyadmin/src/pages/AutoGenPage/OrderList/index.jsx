...
import {queryCustomer, queryCustomerVerboseName} from '@/pages/AutoGenPage/CustomerList/service';
...
const TableList = () => {
  ...
  const dateFieldList = ["order_date"]
  const base_columns = [{
